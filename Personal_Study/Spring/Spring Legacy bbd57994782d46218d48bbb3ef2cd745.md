...
- 설정
    ...
    - 기본 Spring 설정
        ...
        - Preferences에서 User Settings에서 maven의 settings.xml 파일 지정
            ...
            ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%201.png)
...
- IoC 컨테이너
    ...
    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%2016.png)
...
- @Configuration의 하위 속성들
    ...
    - @ComponentScan, Filter
        - Java Configuration 방식
            - ComponentScan의 경우, 동일 범위의 패키지는 자동으로 인식한다. 하지만 이럴 경우 bean으로 만들 모든 파일의 패키지마다 설정 파일의 생성이 필요해지므로, 별도의 설정폴더에서 @ComponentScan을 통해 스캔할 패키지의 범위를 지정하는 방식이 유지보수성 측면에서 더 수월함을 기억하자.
                ...
                ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%2022.png)
    ...
    - @Autowired
        ...
        - Construtor Injection
            ...
            - 필드에 final 키워드를 사용하여 변경 불가능한 Bean을 만들 수 있다.
                ...
                ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%2028.png)
    ...
    - @Inject
        ...
        ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%2040.png)
    ...
    - @initMethod, destroyMethod
        ...
        - 클래스 method에서 직접 설정하는 방식 (Annotation 방식)
            ...
            ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%2051.png)
...
- 용어
    ...
    - @PointCut
        ...
        - 표현식
            ...
            ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%2057.png)
...
- 정의
    ...
    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%2066.png)
...
- 타입 인스턴스 생성
    ...
    - .forName() 메소드
        ...
        ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%2068.png)
    ...
    - 정보 반환
        ...
        - 생성자 정보 반환
            ...
            ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%2072.png)
...
- 정의
    ...
    가 필요하다.
        ...
        ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%2075.png)
...
- 전파행위 옵션
    ...
    - MANDATORY : 반드시 트랜잭션을 걸고 현재 메소드를 실행하되 진행중인 트랜잭션이 있으면 예외를 던진다.
        ...
        ![KakaoTalk_20220628_184318611.png](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/KakaoTalk_20220628_184318611.png)
        
    - NEVER : 반드시 트랜잭션 없이 현재 메소드를 실행하되 진행중인 트랜잭션이 있으면 예외를 던진다.
        
        ![3.png](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/3.png)
        
    - NESTED : 진행중인 트랜잭션이 있으면 현재 메소드를 이 트랜잭션의 중첩트랜잭션 내에서 실핸한다. 진행중인 트랜잭션이 없으면 새 트랜잭션을 실핸한다.
        
        ![KakaoTalk_20220628_184318691.png](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/KakaoTalk_20220628_184318691.png)
...
- Transaction 처리
    - 개념과 xml 방식 처리
        ...
        - DefaultTransactionDefinition 객체 생성
            ...
            ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%2091.png)
...
- 정의와 활용
    ...
    - Handler Mapping
        ...
        - Dispatcher Servlet을 통한 Handler Mapping
            - Method 방식 및 기본 개념
                ...
                - @RequestMapping이 아닌, @GetMapping과 @PostMapping을 활용하여 Request 요청에 대해 method 타입을 별도로 지정하지 않고 받아둘 수 있다 방식은 아래와 같다.
                    ...
                    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20113.png)
        ...
        - @ModelAttribute
            ...
            → Controller에서 jsp로 model의 Attribute를 redirect 할 때 :
                ...
                ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20130.png)
    ...
    - ViewResolver
        ...
        ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20134.png)
...
- 기능
    ...
    - (Handler) Interceptor
        ...
        - postHandle
            ...
            ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20140.png)
    ...
    - File Upload
        ...
        - 이 때 transferTo는 예외처리가 필요하며, try-catch를 활용한 성공 / 실패에 따른 로직 처리는 아래와 같다.
            ...
            ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20150.png)
            
        - 다수의 파일을 동시에 업로드 할 경우에는 List<Map<String, String>> 을 활용한다.
    - Bcrypt
        - Bcrypt Lib DI
            
            ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20151.png)
            
        - Bean 객체 생성
            
            ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20152.png)
            
        - private final 변수 생성과 생성자 방식의 Bean 객체 주입
            
            ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20153.png)
            
        - Controller에서의 encode와 객체 활용
            
            ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20154.png)
...
- DI
    ...
    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20155.png)
    
- 활용
    - Gson으로 가져온 데이터 화면단에 출력
        - Java에서 넘어온 데이터 처리
            
            ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20156.png)
            ...
            - $noTd = $(”<td>”).text(data[index].no); 를 통해 $(”<tr>”) 이라는 element를 만든 뒤, .text()를 통해인덱스에 저장된 JS 배열 안의 속성값(자바에서 파싱되어 넘어온) 들을 인덱스 순서로 꺼내온 뒤 jQuery 변수에 담을 수 있다.
                ...
                ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20157.png)
            ...
            - Java단에서 Parsing 하지 않고 ModelAndView 객체로 보냈을 때는 data.keyValue 형식으로 접근 후 파싱 처리를 진행해줘야 한다. 방식은 아래와 같다.
                ...
                ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20158.png)
        ...
        - Java에서 Json 문자열로 변환 및 전송
            - PrintWriter Stream
                ...
                - MIME 타입과 인코딩 설정
                    ...
                    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20159.png)
                    
                - Gson 객체 생성 및 설정
                    
                    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20160.png)
                    
                - PrintWriter 로 출력
                    
                    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20161.png)
            ...
            - @ResponseBody
                ...
                - 그 외 사항은 이전과 동일하다.
                    ...
                    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20162.png)
                    
            - jsonView
                - jsonView를 위해 별도의 라이브러리 Dependency Injection 과정이 필요하다. (pom.xml)
                    
                    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20163.png)
                    
                - bean객체로 만든 jsonView
                    
                    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20164.png)
                ...
                - ModelAndView 객체를 이용할 경우, addObject를 활용하여 resultView에 다수의 객체를 보낼 수 있다는 장점도 있다.
                    ...
                    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20165.png)
        ...
        - Java에서 Jackson 문자열로 반환 및 전송
            ...
            - pom.xml에서 별도의 라이브러리 dependency Injection이 필요하다.
                ...
                ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20166.png)
                
            - stream을 이용한 방법
                - 날짜 데이터 포맷을 변경하려면 자바 클래스에서 관련 설정을 추가하는 과정이 필요하다.
                    
                    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20167.png)
                ...
                - 이후 설정값이 저장된 DTO 객체를 ObjectMapper 클래스의 인스턴스를 생성, 해당 mapper 레퍼런스 변수에 writeValueAsString 내장메서드에 비지니스 로직 과정에서 받은 결과값을 매개변수로 담아 보내는 방식으로 구현한다.
                    ...
                    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20168.png)
            ...
            - @ResponseBody를 이용한 방법
                ...
                - 이후 writeValueAsString 내장 메서드를 이용하여 결과값을 반환한다.
                    ...
                    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20169.png)
            ...
            - @ResponseBody와 MessageConverter를 사용하는 방법
                ...
                - InternalResourceViewResolver와 동일하게 prefix와 suffix를 내부 알고리즘을 통해 덧붙이며, Json 문자열 형태로 변환도 이루어진다.
                    ...
                    ![Untitled](Spring%20Legacy%20bbd57994782d46218d48bbb3ef2cd745/Untitled%20170.png)
